const KS_API_BASE_URL = 'http://139.162.41.197:8001/api/ks'
const PB_API_BASE_URL = 'http://139.162.41.197:8001/api/pb'
const JU_API_BASE_URL = 'http://139.162.41.197:8001/api/ju'
const JP_API_BASE_URL = 'http://139.162.41.197:8001/api/jp'
const JPA_API_BASE_URL = 'http://139.162.41.197:8001/api/jpa'
const NB_API_BASE_URL = 'http://139.162.41.197:8001/api/nb'
const AUTH_API_BASE_URL = 'http://139.162.41.197:8001/api/auth'
const APV_API_BASE_URL = 'http://139.162.41.197:8001/api/apv'
const AP_API_BASE_URL = 'http://139.162.41.197:8001/api/ap'
const JPB_API_BASE_URL = 'http://139.162.41.197:8001/api/jpb'
const MODUL_API_BASE_URL = 'http://139.162.41.197:8001/api/modul'
const ROLE_API_BASE_URL = 'http://139.162.41.197:8001/api/role'
const BB_API_BASE_URL = 'http://139.162.41.197:8001/api/bb'
const AKUN_API_BASE_URL = 'http://139.162.41.197:8001/api/akun'
const VT_API_BASE_URL = 'http://139.162.41.197:8001/api/vt'
const VB_API_BASE_URL = 'http://139.162.41.197:8001/api/vb'
